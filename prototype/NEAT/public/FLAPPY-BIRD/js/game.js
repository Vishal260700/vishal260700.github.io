...
Game0.prototype.start = function(){
	this.interval = 0;
	this.score = 0;
	this.pipes = [];
	this.birds = [];
...
Game0.prototype.update = function(){
...
Game0.prototype.isItEnd = function(){
	for(var i in this.birds){
		if(this.birds[i].alive){
			return false;
		}
...
Game0.prototype.display = function(){
...
window.onload = function(){
	var sprites = {
		bird:"./public/FLAPPY-BIRD/img/bird.png",
		background:"./public/FLAPPY-BIRD/img/background.png",
		pipetop:"./public/FLAPPY-BIRD/img/pipetop.png",
		pipebottom:"./public/FLAPPY-BIRD/img/pipebottom.png"
	}
